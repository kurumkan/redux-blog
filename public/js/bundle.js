...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_posts = __webpack_require__(264);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _posts_index = __webpack_require__(267);

	var _posts_index2 = _interopRequireDefault(_posts_index);

	var _posts_new = __webpack_require__(294);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var API_KEY = '?key=kurumkan';

	function fetchPosts() {
		var request = _axios2.default.get(ROOT_URL + API_KEY);
		return {
			type: 'FETCH_POSTS',
			payload: request
		};
	...
	function createPost(post) {
		var request = _axios2.default.post(ROOT_URL + API_KEY, post);
